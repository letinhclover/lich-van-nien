    ...
    <div className="flex flex-col pb-24">
      ...
      <div className="pt-3">
        <AnimatePresence mode="wait">
          ...
          {tool === "chuong" && (
            <motion.div key="chuong" initial={{opacity:0,y:8}} animate={{opacity:1,y:0}} exit={{opacity:0}} className="px-4">
              <MeditationBell />
            </motion.div>
          )}
          {tool === "tuoi" && (
